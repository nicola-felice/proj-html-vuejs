    ...
    <div class="container">
      ...
      <div class="video_companionship_wrapper">
        <div class="video_container">
          ...
          <!-- shapes -->
          <img class="pattern shape_1" ref="shape_1" src="../../assets/img/shapes/maxcoach-shape-05-150x150.png" alt="">
          ...
          <svg class="pattern shape_4" ref="shape_4" xmlns="http://www.w3.org/2000/svg" version="1.1" width="200px" height="202px" viewBox="0 0 200 202">
...
export default {
  ...
  mounted() {
    document.querySelector("#tutoring_section").addEventListener("mousemove", (ev) => { 
      let x = ev.clientX;
      let y = ev.clientY;
